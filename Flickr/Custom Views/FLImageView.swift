...
class FLImageView: UIImageView {
    ...
    @objc func showFullscreen() {
        ...
        if window.viewWithTag(imageTag) == nil {
            ...
            self.closeLabel.frame =  CGRect.init(x: 0, y: window.safeAreaLayoutGuide.layoutFrame.size.height - labelHeight, width: labelWidth, height: labelHeight)
